...
def main():
    ...
    for tissue in tissues:
        ...
        for num in features_num:
            ...
            pickle.dump(parameters, open(save_file + "/params_scale_%s_%s_%d.p" %(tissue, feat_sel, num), "wb"))
            ...
            pickle.dump(predictions, open(save_file + "/pred_scale_%s_%s_%d.p" %(tissue, feat_sel, num), "wb"))
        ...
        pickle.dump(svm_accuracy, open(save_file + "/accuracy_scale_%s_%s.p" % (tissue, feat_sel), "wb"))
