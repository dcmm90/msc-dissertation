...
def train_blood_itsfeatures(betaqn, info, feat_sel = 't_test'):
    ...
    for tissue in tissues:
        ...
        for num in features_num:
            ...
            pickle.dump(predictions, open(save_file + "/pred_train_blood_%s_%s_%d.p" %(tissue, feat_sel, num), "wb"))
        ...
        pickle.dump(svm_accuracy, open(save_file + "/accuracy_train_blood_%s_%s.p" % (tissue, feat_sel), "wb"))
