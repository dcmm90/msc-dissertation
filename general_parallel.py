...
def train_fit(num, ec, info)
    ...
    return features_sel,predictions
...
def main():
    ...
    save_file = os.path.realpath('../data_str_par/')
...
if __name__ == '__main__':
    ...
    for num in features_num:
        features_sel, predictions = train_fit(num, ec, info)
        features_dic[num] = features_sel
