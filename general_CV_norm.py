    ...
    for tissue in tissues:
        ...
        for num in features_num:
            ...
            for i in range(cv_splits):
                ...
                features_file = open_file + "/features_CV_norm_%s_%s_%d_%d.p" % (tissue, feat_sel, num, i)
                if feat_sel == 't_test':
                ...
                pickle.dump(predictions, open(open_file + "/pred_CV_norm_%s_%s_%d_%d.p" %(tissue, feat_sel, num, i), "wb"))
            ...
            pickle.dump(svm_accuracy, open(open_file + "/accuracy_CV_norm_%s_%s_%d.p" % (tissue, feat_sel,num), "wb"))
            ...
            pickle.dump(parameters, open(open_file + "/params_CV_norm_%s_%s_%d.p" %(tissue, feat_sel, num), "wb"))
